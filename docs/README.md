...
| [11 — MCP Contract](11-mcp-contract.md) | Cross-product MCP server contract (SentinelCore/FireDog/CyberSheppard): transport, API-key auth, tool naming, response envelope |
